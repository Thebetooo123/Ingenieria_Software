 ...
 * @author ironfart
 */
public class frmVtas extends javax.swing.JFrame implements Runnable {

    /**
     * Creates new form frmVtas
     */
    public frmVtas() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVtas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
