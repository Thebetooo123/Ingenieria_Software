 ...
 * @author ironfart
 */
public class PpalEnc extends javax.swing.JFrame implements Runnable {

    /**
     * Creates new form PpalEnc
     */
    public PpalEnc() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PpalEnc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
